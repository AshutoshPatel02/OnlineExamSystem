...
<head>
  ...
  <link rel="icon" href="./images/exam.png" type="image/x-icon">
...
<body>
  <div class="header">
    <div class="row">
      <div class="col-lg-6">
        <span class="logo">KARESOFT - Online Examination</span>
      </div>
  ...
  <div class="bg1" style="background-image: url('images/front.jpg');height:655px;">
    <div class="row">
      <div class="col-md-7"></div>
      <div class="col-md-4 panel" style="border-color: black;">
        <!-- REGISTER FORM begins -->
        <form class="form-horizontal" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST">
          <fieldset>

            <p class="text-center"><b>Create New Account</b></p>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="mob" name="mob" placeholder="Contact Number" class="form-control input-md" maxlength="10" type="number" onKeyPress="if(this.value.length>9) return false;">
              </div>
            </div>
  ...
  <!--Footer start-->
  <div class="row footer" style="position: absolute; bottom: 0; width: 105%; height:50px;">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Ashutosh Patel</a> <br>
              <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Siddhartha Reddy</a> <br>
              <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Krishna Reddy</a><br>
              <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Ramesh Reddy</a>
              ...
              <h4 style="font-family:'typo' ">Kalasalingam Academy Of Research and Education</h4>
            </div>
          </div>
          </p>
        </div>
  ...
  <div class="modal fade" id="login">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
          <h4 class="modal-title"><span style="color:black;font-family:'typo' ">
